...
import 'package:wonder_tool/screens/main/news_tribe/news_details.dart';
...
class NewsItemWidget extends GetView<NewsController> {
  ...
  const NewsItemWidget({Key? key, required this.post}) : super(key: key);
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(
            flex: 5,
            child: InkWell(
              onTap: () => Get.to(() => NewsDetailsScreen(post: post)),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Padding(
